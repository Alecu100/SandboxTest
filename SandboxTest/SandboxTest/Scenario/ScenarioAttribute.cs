...
namespace SandboxTest.Scenario
{
    ...
    /// For each step, one or more controllers can be invoked to actually execute test logic for that given step using <see cref="ScenarioStep.InvokeController{TController}(Func{TController, ScenarioData, Task}, string?)"/>.
    /// </summary>
