...
{
    public class ApplicationHostedInstanceLoadContext : AssemblyLoadContext
    {
        private AssemblyDependencyResolver _resolver;

        public ApplicationHostedInstanceLoadContext(string mainAssemblyToLoadPath) : base(isCollectible: true)
        {
